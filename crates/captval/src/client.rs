...
//! # Captval Client
//!
//! The Captval Client struct provides an http client to connect to
//! the Captval API.
//!
...
#[cfg_attr(docsrs, allow(rustdoc::missing_doc_code_examples))]
impl Client {
    /// Create a new Captval Client to connect with the default Captval
    ...
    /// Create a new Captval Client and specify the url for the API.
    ///
    /// Specify the url for the captval API.
    ///
    /// # Example
    /// Initialise client to connect to custom Captval API
    /// ```
    ///     use captval::Client;
    ///     use url::Url;
    ///
    ...
    /// Set the url.
    ///
    /// Specify the url for the captval API. This method is useful
