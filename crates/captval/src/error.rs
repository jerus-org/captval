...
// /// Error code mapping for the error responses from the captval API.
...
//     ///
//     /// ```toml
//     /// captval = {version = "2.3.0", default-features = false, features = [rustls-backend]}
//     /// ```
...
//     /// Custom deserialize to map the captval API error codes for reporting as
